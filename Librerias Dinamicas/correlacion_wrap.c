...
/*-----------------------------------------------
              @(target):= _correlacion.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__correlacion

#else
#  define SWIG_init    init_correlacion

#endif
#define SWIG_name    "_correlacion"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_corrCoef(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:corrCoef",&obj0,&obj1)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1 
    };
  ...
  result = (float)corrCoef(arg1,arg2,arg3,arg4);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"corrCoef", _wrap_corrCoef, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
